import { fileFetcher } from '../core/file_fetcher.js';
...
export function svgDebug(projection, context) {
  ...
  function drawDebug(selection) {
    ...
    fileFetcher.get('imagery').then(d => {
    ...
    let downloaded = layer.selectAll('path.debug-downloaded').
