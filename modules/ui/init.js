...
export function uiInit(context) {
  ...
  function render(container) {
    ...
    const overMap = content.append('div')
      .attr('class', 'over-map');
    ...
    const controls = controlsWrap.append('div')
    ...
    const panes = overMap.append('div')
  ...
  ui.togglePanes = function(showPane) {
    let hidePanes = context.container()
      .selectAll('.map-pane.shown');
